...
class Clothing extends Product{
 sizeChartLink;
 constructor(productDetailes){
  super(productDetailes);
  this.sizeChartLink=productDetailes.sizeChartLink;
 }

 ExtraInfoHTML(){
  //method overRiding
  return `
  <a href="${this.sizeChartLink}" target="_self">Size Chart</a>
  `;
 }
}
...
//below code works currect but we are useing a varible name ***priceRuppes*** instead *pricecents*
// xhr.addEventListener('load',()=>{
//    products=JSON.parse(xhr.response).map((productDetailes)=>{
//   if(productDetailes.type==="clothing"){
//     return new Clothing(productDetailes);
//   }
...
// fun();
// });
// //open a request and GET [get some data from backend]
